...
// Prosty DTO dla odpowiedzi serwera, możesz to rozbudować
data class OdpowiedzSerweraKursy(
    val rcSuccess: Boolean,
    val dbSuccess: Boolean, // Jeśli to nadal istotne na tym etapie
    val kursy: Map<String, Double> // Mapa kursów "FROM-TO" -> wartość
)
